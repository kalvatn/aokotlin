...
class Day01Test {
    ...
    @Test
    fun testExamples() {
        val test1 = Day01(PuzzleInput.ofCommaDelimited("+1, -1"))
        val test2 = Day01(PuzzleInput.ofCommaDelimited("+3, +3, +4, -2, -4"))
        val test3 = Day01(PuzzleInput.ofCommaDelimited("-6, +3, +8, +5, -6"))
        val test4 = Day01(PuzzleInput.ofCommaDelimited("+7, +7, -2, -7, -4"))
    ...
    fun testHard() {
        ...
        val testHard = Day01(PuzzleInput.ofCommaDelimited("+10000000, -9999999"))
