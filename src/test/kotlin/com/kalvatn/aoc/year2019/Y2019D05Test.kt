...
internal class Y2019D05Test : BaseDayTest() {
    ...
    override suspend fun examplePartOne() {
        IntcodeComputer(listOf(1002,4,3,4,33)).process().memory shouldBe listOf(1002, 4, 3, 4, 99)
    }
    ...
    override suspend fun examplePartTwo() {
        ...
        (-1000..1000).forEach {
            zeroOrNotImmediateMode.runDiagnostic(it) shouldBe (if (it == 0) 0 else 1)
            zeroOrNotPositionMode.runDiagnostic(it) shouldBe (if (it == 0) 0 else 1)
        }
    }
