...
internal class Y2019D09Test : BaseDayTest() {
    ...
    override suspend fun examplePartOne() {
        IntcodeComputer(listOf(109,1,204,-1,1001,100,1,100,1008,100,16,101,1006,101,0,99)).run().output() shouldBe listOf<Long>(109,1,204,-1,1001,100,1,100,1008,100,16,101,1006,101,0,99)
